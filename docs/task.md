...
=======
- [x] Implement Firebase backend integration
    - [x] Add FlutterFire dependencies
    - [x] Add optional Firebase initialization with anonymous Auth
    - [x] Load furniture catalogue from Firestore with local fallback
    - [x] Load VR rooms and hotspots from Firestore with local fallback
    - [x] Document Firestore schema and security rules
>>>>>>> Stashed changes
